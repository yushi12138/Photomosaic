package com.bigchickenleg.imageselector;
...
import com.bigchickenleg.imageselector.adapter.FolderAdapter;
import com.bigchickenleg.imageselector.adapter.ImageAdapter;
import com.bigchickenleg.imageselector.entry.Folder;
import com.bigchickenleg.imageselector.entry.Image;
import com.bigchickenleg.imageselector.model.ImageModel;
import com.bigchickenleg.imageselector.utils.DateUtils;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, int requestCode,
        ...
        Log.i("debug","ImageSelectorActivity.openActivity()");
        Intent intent = new Intent(activity, ImageSelectorActivity.class);

        intent.putExtras(dataPackages(isSingle, isViewImage, useCamera, maxSelectCount, selected));
        Log.i("debug","ImageSelectorActivity.openActivity()2");
        activity.startActivityForResult(intent, requestCode);
        Log.i("debug","ImageSelectorActivity.openActivity()3");
    ...
    public static Bundle dataPackages(boolean isSingle, boolean isViewImage, boolean useCamera,
                                      int maxSelectCount, ArrayList<String> selected) {
        Log.i("debug","ImageSelectorActivity.Bundle()");
        ...
        Log.i("debug","ImageSelectorActivity.Bundle()2");
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.i("debug","ImageSelectorActivity.onCreate()");
